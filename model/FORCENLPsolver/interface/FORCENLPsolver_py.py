...
a Python wrapper for a fast solver generated by FORCESPRO v5.1.0
   ...
   subject to the parameters supplied in the following dictionary:
       ...
       PARAMS['x0'] - column vector of length 330
       PARAMS['all_parameters'] - column vector of length 180
       PARAMS['reinitialize'] - scalar

   OUTPUT returns the values of the last iteration of the solver where
       OUTPUT['x01'] - column vector of size 11
       OUTPUT['x02'] - column vector of size 11
       OUTPUT['x03'] - column vector of size 11
       OUTPUT['x04'] - column vector of size 11
       OUTPUT['x05'] - column vector of size 11
       OUTPUT['x06'] - column vector of size 11
       OUTPUT['x07'] - column vector of size 11
       OUTPUT['x08'] - column vector of size 11
       OUTPUT['x09'] - column vector of size 11
       OUTPUT['x10'] - column vector of size 11
       OUTPUT['x11'] - column vector of size 11
       OUTPUT['x12'] - column vector of size 11
       OUTPUT['x13'] - column vector of size 11
       OUTPUT['x14'] - column vector of size 11
       OUTPUT['x15'] - column vector of size 11
       OUTPUT['x16'] - column vector of size 11
       OUTPUT['x17'] - column vector of size 11
       OUTPUT['x18'] - column vector of size 11
       OUTPUT['x19'] - column vector of size 11
       OUTPUT['x20'] - column vector of size 11
       OUTPUT['x21'] - column vector of size 11
       OUTPUT['x22'] - column vector of size 11
       OUTPUT['x23'] - column vector of size 11
       OUTPUT['x24'] - column vector of size 11
       OUTPUT['x25'] - column vector of size 11
       OUTPUT['x26'] - column vector of size 11
       OUTPUT['x27'] - column vector of size 11
       OUTPUT['x28'] - column vector of size 11
       OUTPUT['x29'] - column vector of size 11
       OUTPUT['x30'] - column vector of size 11
...
#    def from_param(self):
#        return self
    _fields_ = [('x01', ctypes.c_double * 11),
('x02', ctypes.c_double * 11),
('x03', ctypes.c_double * 11),
('x04', ctypes.c_double * 11),
('x05', ctypes.c_double * 11),
('x06', ctypes.c_double * 11),
('x07', ctypes.c_double * 11),
('x08', ctypes.c_double * 11),
('x09', ctypes.c_double * 11),
('x10', ctypes.c_double * 11),
('x11', ctypes.c_double * 11),
('x12', ctypes.c_double * 11),
('x13', ctypes.c_double * 11),
('x14', ctypes.c_double * 11),
('x15', ctypes.c_double * 11),
('x16', ctypes.c_double * 11),
('x17', ctypes.c_double * 11),
('x18', ctypes.c_double * 11),
('x19', ctypes.c_double * 11),
('x20', ctypes.c_double * 11),
('x21', ctypes.c_double * 11),
('x22', ctypes.c_double * 11),
('x23', ctypes.c_double * 11),
('x24', ctypes.c_double * 11),
('x25', ctypes.c_double * 11),
('x26', ctypes.c_double * 11),
('x27', ctypes.c_double * 11),
('x28', ctypes.c_double * 11),
('x29', ctypes.c_double * 11),
('x30', ctypes.c_double * 11),
]
