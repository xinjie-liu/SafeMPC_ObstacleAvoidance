...
/* Generated by FORCESPRO v5.1.0 on Friday, March 18, 2022 at 8:31:42 PM */
...
typedef struct MPC_Project_FORCESPRO_params
{
    ...
    /* matrix of size [6 x 10] (column major format) */
    MPC_Project_FORCESPRO_float linear_model5[60];

    /* matrix of size [6 x 10] (column major format) */
    MPC_Project_FORCESPRO_float linear_model6[60];

    /* matrix of size [6 x 10] (column major format) */
    MPC_Project_FORCESPRO_float linear_model7[60];

    /* matrix of size [6 x 10] (column major format) */
    MPC_Project_FORCESPRO_float linear_model8[60];

    /* matrix of size [6 x 10] (column major format) */
    MPC_Project_FORCESPRO_float linear_model9[60];

    /* matrix of size [1 x 10] (column major format) */
    MPC_Project_FORCESPRO_float hyperplaneA1[10];

    /* matrix of size [1 x 10] (column major format) */
    MPC_Project_FORCESPRO_float hyperplaneA2[10];

    /* matrix of size [1 x 10] (column major format) */
    MPC_Project_FORCESPRO_float hyperplaneA3[10];

    /* matrix of size [1 x 10] (column major format) */
    MPC_Project_FORCESPRO_float hyperplaneA4[10];

    /* matrix of size [1 x 10] (column major format) */
    MPC_Project_FORCESPRO_float hyperplaneA5[10];

    /* matrix of size [1 x 10] (column major format) */
    MPC_Project_FORCESPRO_float hyperplaneA6[10];

    /* matrix of size [1 x 10] (column major format) */
    MPC_Project_FORCESPRO_float hyperplaneA7[10];

    /* matrix of size [1 x 10] (column major format) */
    MPC_Project_FORCESPRO_float hyperplaneA8[10];

    /* matrix of size [1 x 10] (column major format) */
    MPC_Project_FORCESPRO_float hyperplaneA9[10];

    /* matrix of size [1 x 10] (column major format) */
    MPC_Project_FORCESPRO_float hyperplaneA10[10];

    /* vector of size 1 */
    MPC_Project_FORCESPRO_float hyperplaneb1[1];

    /* vector of size 1 */
    MPC_Project_FORCESPRO_float hyperplaneb2[1];

    /* vector of size 1 */
    MPC_Project_FORCESPRO_float hyperplaneb3[1];

    /* vector of size 1 */
    MPC_Project_FORCESPRO_float hyperplaneb4[1];

    /* vector of size 1 */
    MPC_Project_FORCESPRO_float hyperplaneb5[1];

    /* vector of size 1 */
    MPC_Project_FORCESPRO_float hyperplaneb6[1];

    /* vector of size 1 */
    MPC_Project_FORCESPRO_float hyperplaneb7[1];

    /* vector of size 1 */
    MPC_Project_FORCESPRO_float hyperplaneb8[1];

    /* vector of size 1 */
    MPC_Project_FORCESPRO_float hyperplaneb9[1];

    /* vector of size 1 */
    MPC_Project_FORCESPRO_float hyperplaneb10[1];
...
{
    /* vector of size 100 */
    MPC_Project_FORCESPRO_float output[100];
...
/* Time of Solver Generation: (UTC) Friday, March 18, 2022 8:31:43 PM */
...
/* Solver Generation Request Id: ef000092-ac0c-4515-a51c-14b290fa24c9 */
