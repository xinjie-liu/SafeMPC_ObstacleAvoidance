...
('linear_model3', ctypes.c_double * 60),
('linear_model4', ctypes.c_double * 60),
('linear_model5', ctypes.c_double * 60),
('linear_model6', ctypes.c_double * 60),
('linear_model7', ctypes.c_double * 60),
('linear_model8', ctypes.c_double * 60),
('linear_model9', ctypes.c_double * 60),
('hyperplaneA1', ctypes.c_double * 20),
('hyperplaneA2', ctypes.c_double * 20),
('hyperplaneA3', ctypes.c_double * 20),
('hyperplaneA4', ctypes.c_double * 20),
('hyperplaneA5', ctypes.c_double * 20),
('hyperplaneA6', ctypes.c_double * 20),
('hyperplaneA7', ctypes.c_double * 20),
('hyperplaneA8', ctypes.c_double * 20),
('hyperplaneA9', ctypes.c_double * 20),
('hyperplaneA10', ctypes.c_double * 20),
('hyperplaneb1', ctypes.c_double * 2),
('hyperplaneb2', ctypes.c_double * 2),
('hyperplaneb3', ctypes.c_double * 2),
('hyperplaneb4', ctypes.c_double * 2),
('hyperplaneb5', ctypes.c_double * 2),
('hyperplaneb6', ctypes.c_double * 2),
('hyperplaneb7', ctypes.c_double * 2),
('hyperplaneb8', ctypes.c_double * 2),
('hyperplaneb9', ctypes.c_double * 2),
('hyperplaneb10', ctypes.c_double * 2),
]
...
'hyperplaneA4' : np.array([]),
'hyperplaneA5' : np.array([]),
'hyperplaneA6' : np.array([]),
'hyperplaneA7' : np.array([]),
'hyperplaneA8' : np.array([]),
'hyperplaneA9' : np.array([]),
'hyperplaneA10' : np.array([]),
'hyperplaneb1' : np.array([]),
'hyperplaneb2' : np.array([]),
'hyperplaneb3' : np.array([]),
'hyperplaneb4' : np.array([]),
'hyperplaneb5' : np.array([]),
'hyperplaneb6' : np.array([]),
'hyperplaneb7' : np.array([]),
'hyperplaneb8' : np.array([]),
'hyperplaneb9' : np.array([]),
'hyperplaneb10' : np.array([]),
}
...
'hyperplaneA4' : np.float64,
'hyperplaneA5' : np.float64,
'hyperplaneA6' : np.float64,
'hyperplaneA7' : np.float64,
'hyperplaneA8' : np.float64,
'hyperplaneA9' : np.float64,
'hyperplaneA10' : np.float64,
'hyperplaneb1' : np.float64,
'hyperplaneb2' : np.float64,
'hyperplaneb3' : np.float64,
'hyperplaneb4' : np.float64,
'hyperplaneb5' : np.float64,
'hyperplaneb6' : np.float64,
'hyperplaneb7' : np.float64,
'hyperplaneb8' : np.float64,
'hyperplaneb9' : np.float64,
'hyperplaneb10' : np.float64,
}
...
#    def from_param(self):
#        return self
    _fields_ = [('output', ctypes.c_double * 100),
]
