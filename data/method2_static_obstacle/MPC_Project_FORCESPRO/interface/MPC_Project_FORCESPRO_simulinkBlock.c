...
static void mdlInitializeSizes(SimStruct *S)
{
	...
	/* Input Port 5 */
    ssSetInputPortMatrixDimensions(S,  5, 2, 10);
	...
	/* Input Port 8 */
    ssSetInputPortMatrixDimensions(S,  8, 2, 1);
	...
	/* Input Port 9 */
    ssSetInputPortMatrixDimensions(S,  9, 2, 1);
	...
	/* Input Port 10 */
    ssSetInputPortMatrixDimensions(S,  10, 2, 1);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
	...
	const real_T *hyperplaneA1 = (const real_T*) ssGetInputPortSignal(S,4);
	const real_T *hyperplaneA2 = (const real_T*) ssGetInputPortSignal(S,5);
	const real_T *hyperplaneA3 = (const real_T*) ssGetInputPortSignal(S,6);
	const real_T *hyperplaneA4 = (const real_T*) ssGetInputPortSignal(S,7);
	const real_T *hyperplaneb1 = (const real_T*) ssGetInputPortSignal(S,8);
	const real_T *hyperplaneb2 = (const real_T*) ssGetInputPortSignal(S,9);
	const real_T *hyperplaneb3 = (const real_T*) ssGetInputPortSignal(S,10);
	const real_T *hyperplaneb4 = (const real_T*) ssGetInputPortSignal(S,11);
