...
static void mdlInitializeSizes(SimStruct *S)
{
	...
	/* Input Port 7 */
    ssSetInputPortMatrixDimensions(S,  7, 2, 1);
	...
	/* Output Port 0 */
    ssSetOutputPortMatrixDimensions(S,  0, 30, 1);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
	...
	const real_T *hyperplaneb1 = (const real_T*) ssGetInputPortSignal(S,7);
	const real_T *hyperplaneb2 = (const real_T*) ssGetInputPortSignal(S,8);
	const real_T *hyperplaneb3 = (const real_T*) ssGetInputPortSignal(S,9);
