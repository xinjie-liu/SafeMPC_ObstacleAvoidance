...
static void mdlInitializeSizes(SimStruct *S)
{
	...
	/* Input Port 0 */
    ssSetInputPortMatrixDimensions(S,  0, 6, 20);
	...
	/* Input Port 1 */
    ssSetInputPortMatrixDimensions(S,  1, 2, 3);
	...
	/* Input Port 2 */
    ssSetInputPortMatrixDimensions(S,  2, 2, 30);
	...
	/* Input Port 4 */
    ssSetInputPortMatrixDimensions(S,  4, 10, 10);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
	...
	const real_T *terminal_cost = (const real_T*) ssGetInputPortSignal(S,4);
