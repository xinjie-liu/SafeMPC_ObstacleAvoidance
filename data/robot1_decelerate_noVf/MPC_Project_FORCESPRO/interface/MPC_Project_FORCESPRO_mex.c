...
void mexFunction( solver_int32_default nlhs, mxArray *plhs[], solver_int32_default nrhs, const mxArray *prhs[] )  
{
	...
	par = mxGetField(PARAMS, 0, "terminal_cost");
#ifdef MEXARGMUENTCHECKS
    if( par == NULL )	
	{
        mexErrMsgTxt("PARAMS.terminal_cost not found");
    }
    if( !mxIsDouble(par) )
    {
    mexErrMsgTxt("PARAMS.terminal_cost must be a double.");
    }
    if( mxGetM(par) != 10 || mxGetN(par) != 10 ) 
	{
    mexErrMsgTxt("PARAMS.terminal_cost must be of size [10 x 10]");
    }
#endif	 
	if ( (mxGetN(par) != 0) && (mxGetM(par) != 0) )
	{
		copyMArrayToC_double(mxGetPr(par), params.terminal_cost,100);
    ...
    if( mxGetM(par) != 2 || mxGetN(par) != 10 ) 
	{
    mexErrMsgTxt("PARAMS.hyperplaneA5 must be of size [2 x 10]");
    }
#endif	 
	if ( (mxGetN(par) != 0) && (mxGetM(par) != 0) )
	{
		copyMArrayToC_double(mxGetPr(par), params.hyperplaneA5,20);
    ...
    if( mxGetM(par) != 2 || mxGetN(par) != 10 ) 
	{
    mexErrMsgTxt("PARAMS.hyperplaneA6 must be of size [2 x 10]");
    }
#endif	 
	if ( (mxGetN(par) != 0) && (mxGetM(par) != 0) )
	{
		copyMArrayToC_double(mxGetPr(par), params.hyperplaneA6,20);
    ...
    if( mxGetM(par) != 2 || mxGetN(par) != 10 ) 
	{
    mexErrMsgTxt("PARAMS.hyperplaneA7 must be of size [2 x 10]");
    }
#endif	 
	if ( (mxGetN(par) != 0) && (mxGetM(par) != 0) )
	{
		copyMArrayToC_double(mxGetPr(par), params.hyperplaneA7,20);
    ...
    if( mxGetM(par) != 2 || mxGetN(par) != 10 ) 
	{
    mexErrMsgTxt("PARAMS.hyperplaneA8 must be of size [2 x 10]");
    }
#endif	 
	if ( (mxGetN(par) != 0) && (mxGetM(par) != 0) )
	{
		copyMArrayToC_double(mxGetPr(par), params.hyperplaneA8,20);
    ...
    if( mxGetM(par) != 2 || mxGetN(par) != 10 ) 
	{
    mexErrMsgTxt("PARAMS.hyperplaneA9 must be of size [2 x 10]");
    }
#endif	 
	if ( (mxGetN(par) != 0) && (mxGetM(par) != 0) )
	{
		copyMArrayToC_double(mxGetPr(par), params.hyperplaneA9,20);
    ...
    if( mxGetM(par) != 2 || mxGetN(par) != 10 ) 
	{
    mexErrMsgTxt("PARAMS.hyperplaneA10 must be of size [2 x 10]");
    }
#endif	 
	if ( (mxGetN(par) != 0) && (mxGetM(par) != 0) )
	{
		copyMArrayToC_double(mxGetPr(par), params.hyperplaneA10,20);
    ...
    if( mxGetM(par) != 2 || mxGetN(par) != 1 ) 
	{
    mexErrMsgTxt("PARAMS.hyperplaneb5 must be of size [2 x 1]");
    }
#endif	 
	if ( (mxGetN(par) != 0) && (mxGetM(par) != 0) )
	{
		copyMArrayToC_double(mxGetPr(par), params.hyperplaneb5,2);
    ...
    if( mxGetM(par) != 2 || mxGetN(par) != 1 ) 
	{
    mexErrMsgTxt("PARAMS.hyperplaneb6 must be of size [2 x 1]");
    }
#endif	 
	if ( (mxGetN(par) != 0) && (mxGetM(par) != 0) )
	{
		copyMArrayToC_double(mxGetPr(par), params.hyperplaneb6,2);
    ...
    if( mxGetM(par) != 2 || mxGetN(par) != 1 ) 
	{
    mexErrMsgTxt("PARAMS.hyperplaneb7 must be of size [2 x 1]");
    }
#endif	 
	if ( (mxGetN(par) != 0) && (mxGetM(par) != 0) )
	{
		copyMArrayToC_double(mxGetPr(par), params.hyperplaneb7,2);
    ...
    if( mxGetM(par) != 2 || mxGetN(par) != 1 ) 
	{
    mexErrMsgTxt("PARAMS.hyperplaneb8 must be of size [2 x 1]");
    }
#endif	 
	if ( (mxGetN(par) != 0) && (mxGetM(par) != 0) )
	{
		copyMArrayToC_double(mxGetPr(par), params.hyperplaneb8,2);
    ...
    if( mxGetM(par) != 2 || mxGetN(par) != 1 ) 
	{
    mexErrMsgTxt("PARAMS.hyperplaneb9 must be of size [2 x 1]");
    }
#endif	 
	if ( (mxGetN(par) != 0) && (mxGetM(par) != 0) )
	{
		copyMArrayToC_double(mxGetPr(par), params.hyperplaneb9,2);
    ...
    if( mxGetM(par) != 2 || mxGetN(par) != 1 ) 
	{
    mexErrMsgTxt("PARAMS.hyperplaneb10 must be of size [2 x 1]");
    }
#endif	 
	if ( (mxGetN(par) != 0) && (mxGetM(par) != 0) )
	{
		copyMArrayToC_double(mxGetPr(par), params.hyperplaneb10,2);
