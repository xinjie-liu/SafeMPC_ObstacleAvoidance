...
/* Generated by FORCESPRO v5.1.0 on Monday, April 4, 2022 at 6:14:33 PM */
...
typedef struct MPC_Project_FORCESPRO_params
{
    ...
    /* matrix of size [2 x 10] (column major format) */
    MPC_Project_FORCESPRO_float hyperplaneA6[20];

    /* matrix of size [2 x 10] (column major format) */
    MPC_Project_FORCESPRO_float hyperplaneA7[20];

    /* matrix of size [2 x 10] (column major format) */
    MPC_Project_FORCESPRO_float hyperplaneA8[20];

    /* matrix of size [2 x 10] (column major format) */
    MPC_Project_FORCESPRO_float hyperplaneA9[20];

    /* matrix of size [2 x 10] (column major format) */
    MPC_Project_FORCESPRO_float hyperplaneA10[20];
    ...
    /* vector of size 2 */
    MPC_Project_FORCESPRO_float hyperplaneb6[2];

    /* vector of size 2 */
    MPC_Project_FORCESPRO_float hyperplaneb7[2];

    /* vector of size 2 */
    MPC_Project_FORCESPRO_float hyperplaneb8[2];

    /* vector of size 2 */
    MPC_Project_FORCESPRO_float hyperplaneb9[2];

    /* vector of size 2 */
    MPC_Project_FORCESPRO_float hyperplaneb10[2];
...
/* Time of Solver Generation: (UTC) Monday, April 4, 2022 6:14:34 PM */
...
/* Solver Generation Request Id: 5a729ee1-a222-45a5-8b91-7290095c913f */
